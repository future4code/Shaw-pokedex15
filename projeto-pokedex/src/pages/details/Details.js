      ...
      <Container>
        ...
        <Card2>
          ...
          <div>
            <p>
              {" "}
              <strong>HP: </strong>
              {details.stats && details.stats[0].base_stat}{" "}
            </p>
            <p>
              {" "}
              <strong>Attack: </strong>
              {details.stats && details.stats[1].base_stat}{" "}
            </p>
            <p>
              {" "}
              <strong>Defense: </strong>
              {details.stats && details.stats[2].base_stat}{" "}
            </p>
            <p>
              {" "}
        ...
        <Card3>
          ...
          <div>
            ...
            <p>
              {details.moves && details.moves[0]
                ? details.moves[0].move.name
                : null}{" "}
            </p>
            <p>
              {details.moves && details.moves[1]
                ? details.moves[1].move.name
                : null}{" "}
            </p>
            <p>
              {details.moves && details.moves[2]
                ? details.moves[2].move.name
                : null}{" "}
            </p>
            <p>
              {details.moves && details.moves[3]
                ? details.moves[3].move.name
                : null}{" "}
            </p>
            <p>
              {details.moves && details.moves[4]
                ? details.moves[4].move.name
                : null}{" "}
            </p>
          </div>
        </Card3>
